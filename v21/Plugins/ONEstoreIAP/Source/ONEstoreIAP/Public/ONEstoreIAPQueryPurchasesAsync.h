...
#include "ONEstoreIAPQueryPurchasesAsync.generated.h"
...
UCLASS(MinimalAPI)
class UONEstoreIAPQueryPurchasesAsync : public UONEstoreIAPAsyncBase
{	
...
protected:
	...
	static UONEstoreIAPQueryPurchasesAsync* QueryPurchaseAsync(
